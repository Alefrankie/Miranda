...
/*Creacion de codigo QR por empleados*/
include ("../qr/qr.php");
...
/*el departamento elige la tabla deonde se va a guardar los datos */
if($departamento=='SECRETARIA DE...'){
	echo "Debe escoger el departamento";
}


else{
	$query="INSERT INTO empleados (user, pass, cedula, nombres, apellidos, n_hijos, telefono, correo, direccion, departamento, oficina, cargo, categoria, condicion, servicio, f_ingreso, f_asignacion, sueldo, p_profesion, p_hijos, p_antiguedad, p_hogar, t_asignaciones) VALUES('$user','$pass','$cedula','$nombres','$apellidos','$n_hijos','$telefono','$correo','$direccion','$departamento','$oficina','$cargo','$categoria','$condicion','$servicio','$f_ingreso','$f_asignacion','$sueldo','$p_profesion','$p_hijos','$p_antiguedad','$p_hogar','$t_asignaciones')";
		}
