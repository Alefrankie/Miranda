<footer>
    ...
    <div class="footer-main">
        <div class="footer-img">
            <img src="<?php echo RUTA_URL ?>/img/logo-footer.png">
        </div>
        ...
        <div class="footer-body">
            ...
            <div class="footer-texto">
                <p>Alcaldia Bolivariana del Municipio Miranda, Avenida Miranda Edificio Ayuntamiento. Entre calle norte y Urdaneta, Santa Ana de Coro, Estado Falcón.</p>
